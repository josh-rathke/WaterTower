...
<div class="row">
	<div class="small-12 large-8 columns" role="main">
		...
		<h2><?php _e('Search Results for', 'watertower'); ?> "<?php echo get_search_query(); ?>"</h2>
	...
	<?php if ( function_exists('watertower_pagination') ) { watertower_pagination(); } else if ( is_paged() ) { ?>
