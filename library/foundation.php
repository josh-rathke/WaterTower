...
function watertower_menu_fallback()
{
	...
	printf(
		__( 'Please assign a menu to the primary menu location under %1$s or %2$s the design.', 'watertower' ),
		sprintf(
			__( '<a href="%s">Menus</a>', 'watertower' ),
			get_admin_url( get_current_blog_id(), 'nav-menus.php' )
		),
		sprintf(
			__( '<a href="%s">Customize</a>', 'watertower' ),
