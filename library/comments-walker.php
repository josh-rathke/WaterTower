         ...
         <div class="row">
          <div class="medium-12 columns">
            <?php if(!$comment->comment_approved ) : ?>
								...
								<?php else: ?>
									<p><span class="comment-author-name"><?php if (0 != count_user_posts($comment->user_id)) { the_author_posts_link(); 
} else { echo get_comment_author_link(); 
} ?></span> - <?php echo str_replace('<p>' and '</p>', '', get_comment_text()); ?></p>
							</div>
						</div>
