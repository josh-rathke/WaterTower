...
/*	Program CPT to Program Prerequisites Taxo
 *	This relationship automatically adds each program as
 *	an option for a Pre-Requisite to another program by adding
 *	a term to the Pre-Requisites taxonomy.
 */
